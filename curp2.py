...
tk.Label(ventana, text="Ingresa tu primer apellido:").place(x=10, y=90)
apellidoPtk = tk.Entry(ventana)
apellidoPtk.place(x=200, y=90)  # Campo de entrada

tk.Label(ventana, text="Ingresa tu segundo apellido:").place(x=10, y=120)
apellidoMtk = tk.Entry(ventana)
apellidoMtk.place(x=200, y=120)  # Campo de entrada

tk.Label(ventana, text="Ingresa tu nombre:").place(x=10, y=150)
nombretk = tk.Entry(ventana)
nombretk.place(x=200, y=150)  # Campo de entrada

tk.Label(ventana, text="Ingresa tu genero:").place(x=10, y=180)
generotk = tk.Entry(ventana)
generotk.place(x=200, y=180)  # Campo de entrada
...
tk.Label(ventana, text="FECHA DE NACIMIENTO").place(x=360,y=160)  # Etiqueta
